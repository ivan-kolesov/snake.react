  ...
  createPanResponder = () =>
    PanResponder.create({
      ...
      onPanResponderMove: (e, { vx, vy }) => {
        ...
        const { directionPan, setDirectionPan, setDirection, direction } =
          this.props;
        ...
        if (absVx > absVy) {
          if (
            [DIRECTION_RIGHT, DIRECTION_LEFT].indexOf(direction) === -1 &&
          ...
          if (
            [DIRECTION_DOWN, DIRECTION_UP].indexOf(direction) === -1 &&
